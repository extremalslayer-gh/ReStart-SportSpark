...
def create_report(request):
    ...
    organization_dict = {  k: v for k, v in json_data['organization'].items() if k.lower() not in ('id', 'creation_time', 'is_autogenerated') }
    now = datetime.now()
...
def edit_report(request):
    ...
    json_data['organization'] = { k: v for k, v in json_data['organization'].items() if k.lower() not in ['id', 'creation_time'] }
    organization.modify_from_dict(json_data['organization'])
